...
// .wrangler/tmp/bundle-WImNrW/strip-cf-connecting-ip-header.js
...
// src/durable-objects/hub-connection.ts
var HubConnection = class {
  ...
  async getHubId() {
    return await this.state.storage.get("hubId");
  }
  /**
...
__name(HubConnection, "HubConnection");

// src/durable-objects/dashboard-broadcast.ts
var DashboardBroadcast = class {
  state;
  env;
  constructor(state, env2) {
    this.state = state;
  ...
  async getTenantId() {
    return await this.state.storage.get("tenantId");
  }
  /**
   * Handle incoming HTTP requests to this Durable Object
   * WebSocket upgrade requests will be handled here in Phase 13-14
...
__name(DashboardBroadcast, "DashboardBroadcast");
...
// .wrangler/tmp/bundle-WImNrW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WImNrW/middleware-loader.entry.ts
