...
**Frontend Source Location**: `C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend/`

```bash
cd C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend
...
cd C:/Users/nlsch/PrintFarmSoftware-Frontend
...
The Raspberry Pi cannot handle Vite build process. Always build frontend on development machine before deployment. The frontend source is maintained locally at `C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend/`.
...
```
C:/Users/nlsch/PrintFarmSoftware-Frontend/
...
1. **Frontend build fails on Pi**: Build on development machine at `C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend/`, not on Pi
...
#### File Editing Method for Claude Code

Claude Code should edit frontend files using Git Bash commands with the local backup directory:

**Read files:**
```bash
cat "C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend/src/hooks/usePrinters.ts"
head -20 "C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend/src/hooks/usePrinters.ts"
```

**Edit files:**
```bash
# Complete file replacement
cat > "C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend/src/hooks/usePrinters.ts" << 'FILEEOF'
// New file content here
FILEEOF

# Targeted replacements  
sed -i 's/old_text/new_text/g' "C:/Users/nlsch/PrintFarmSoftware-Frontend/frontend/src/hooks/usePrinters.ts"
```

**CRITICAL:** Claude Code Read/Edit tools do NOT work with Git Bash Windows paths (/c/Users/...). Always use Bash commands for all file operations.
